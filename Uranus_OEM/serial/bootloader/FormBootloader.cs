...
{
    public partial class FormBootloader : Form
    {
        public delegate bool BootloaderSendDataHandler(byte[] buffer, int index, int count);
        public event BootloaderSendDataHandler OnDataSend;
      ...
      //      Console.Write(a);
        ...
        private bool CmdFlashEraseRegion(int addr, int len)
        {
            ...
            byte[] Resp = WaitData(20, (len > 2000)?(2000):(len)); // the more len , the more time 
            if (Resp.Length == 20)
            {
                    ret = true;
            }
        ...
        private bool CmdExecute(int sp, int pc, int arg)
        {
            ...
            InjectCommand(WarpFramePacket(FramePacketType.kFramingPacketType_Command, Data.ToArray()));
            byte[] Resp = WaitData(20,20); // the more len , the more time 
            if (Resp.Length == 20)
            {
                ret = true;
            }
        ...
        private void buttonSelectFile_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                ImagReader.GetData(textBox1.Text);
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            byte[] FileData = ImagReader.GetData(textBox1.Text);
            ...
            if (checkBox_ExecAfterDownload.Checked == true)
            {
                ...
                Console.WriteLine("从0x" + StartAddr.ToString("X8") + "处执行" + ((ret == true) ? ("成功") : ("失败")));
            }
        ...
        private void FormBootloader_Load(object sender, EventArgs e)
        {
            ...
            {
                textBoxStartAddr.Text = "0x00005000";
            ...
            Console.SetOut(new TextBoxWriter(listBoxLog));
        }
